  ...
  <div class="main">
    <div class="login">
      <a-form @submit="handleSubmit" :autoFormCreate="(form)=>{this.form = form}">
        ...
        <a-form-item>
          <a-button size="large" class="submit" type="primary" htmlType="submit">登录</a-button>
&lt;!&ndash;          <a-button size="large" class="submit" type="primary" htmlType="submit" :loading="submitting">登录</a-button>&ndash;&gt;
        </a-form-item>
        <div class="other">
          其他登录方式
